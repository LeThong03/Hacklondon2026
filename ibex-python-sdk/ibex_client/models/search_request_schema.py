...
class SearchRequestSchema(BaseModel):
    ...
    extensions: Optional[SearchExtensionsSchema] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "input": SearchInputSchema.from_dict(obj["input"]) if obj.get("input") is not None else None,
            "extensions": SearchExtensionsSchema.from_dict(obj["extensions"]) if obj.get("extensions") is not None else None,
            "filters": SearchFiltersSchema.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj

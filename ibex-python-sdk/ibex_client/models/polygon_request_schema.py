...
class PolygonRequestSchema(BaseModel):
    ...
    """ # noqa: E501
    geometry: Optional[PolygonRequestSchemaGeometry] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "geometry": PolygonRequestSchemaGeometry.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None
        })
        return _obj

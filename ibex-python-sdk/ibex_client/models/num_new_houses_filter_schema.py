...
class NumNewHousesFilterSchema(BaseModel):
    """
    Filter applications by number of new houses
    """ # noqa: E501
    min: Optional[StrictInt] = Field(default=None, description="Minimum number of new houses")
    max: Optional[StrictInt] = Field(default=None, description="Maximum number of new houses")

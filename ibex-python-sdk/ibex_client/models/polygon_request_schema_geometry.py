...
class PolygonRequestSchemaGeometry(BaseModel):
    """
    PolygonRequestSchemaGeometry
    """ # noqa: E501
    type: Optional[StrictStr] = None
    coordinates: Optional[List[List[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=2, max_length=2)]]]] = None

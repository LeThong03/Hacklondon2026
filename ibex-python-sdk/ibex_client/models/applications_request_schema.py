...
class ApplicationsRequestSchema(BaseModel):
    """
    ApplicationsRequestSchema
    """ # noqa: E501
    input: ApplicationsInputSchema
    extensions: Optional[ApplicationsExtensionsSchema] = None
    filters: Optional[ApplicationsFiltersSchema] = None
    __properties: ClassVar[List[str]] = ["input", "extensions", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "input": ApplicationsInputSchema.from_dict(obj["input"]) if obj.get("input") is not None else None,
            "extensions": ApplicationsExtensionsSchema.from_dict(obj["extensions"]) if obj.get("extensions") is not None else None,
            "filters": ApplicationsFiltersSchema.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj

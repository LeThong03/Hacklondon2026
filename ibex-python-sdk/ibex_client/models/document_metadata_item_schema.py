...
class DocumentMetadataItemSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["date_published", "document_type", "description", "document_link"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if document_link (nullable) is None
        # and model_fields_set contains the field
        if self.document_link is None and "document_link" in self.model_fields_set:
            _dict['document_link'] = None

...
from ibex_client.api_client import ApiClient, RequestSerialized
from ibex_client.api_response import ApiResponse
from ibex_client.rest import RESTResponseType


class PlanningApplicationsApi:
    ...
    def applications_post(
        self,
        applications_request_schema: ApplicationsRequestSchema,
    ...
    ) -> List[ApplicationsResponseSchema]:
        ...
        :param applications_request_schema: (required)
        :type applications_request_schema: ApplicationsRequestSchema
        ...
        _param = self._applications_post_serialize(
            applications_request_schema=applications_request_schema,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ApplicationsResponseSchema]",
            '400': "ErrorResponse",
            '403': "ErrorResponse",
            '413': "ErrorResponse",
            '500': "ErrorResponse",
    ...
    def applications_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ApplicationsResponseSchema]]:
        """Search planning applications by date range and council
    ...
    def _applications_post_serialize(
        ...
        if applications_request_schema is not None:
            _body_params = applications_request_schema
    ...
    def search_post(
        ...
        :param search_request_schema: (required)
    ...
    def search_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SearchResponseSchema]]:
        """Search for planning applications by location

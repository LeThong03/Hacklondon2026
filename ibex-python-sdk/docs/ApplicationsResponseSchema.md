...
json = "{}"
# create an instance of ApplicationsResponseSchema from a JSON string
applications_response_schema_instance = ApplicationsResponseSchema.from_json(json)
# print the JSON string representation of the object
print(ApplicationsResponseSchema.to_json())

# convert the object into a dict
applications_response_schema_dict = applications_response_schema_instance.to_dict()
# create an instance of ApplicationsResponseSchema from a dict
applications_response_schema_from_dict = ApplicationsResponseSchema.from_dict(applications_response_schema_dict)
```
